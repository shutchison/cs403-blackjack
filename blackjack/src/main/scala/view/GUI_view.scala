...
//  dealerCardPanel.showCards(Dealer2.dealerHand.cards)
//  var dealerHandTextLabel = new Label("Hand total: " + Dealer2.dealerHand.getHandValue())
//
...
//  for (player <- Dealer2.playerQueue.players) {
